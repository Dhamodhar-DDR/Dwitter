...
class Status extends Component {
    ...
    componentDidMount() {
        axios.get("http://localhost:7070/messages/statusmess/" + this.props.match.params.belike)
            .then(res => {
                this.setState({
                    message: res.data[0],
        ...
        axios.get("http://localhost:7070/commentroute/display/" + this.props.match.params.belike + "/" + this.state.comm_num)
            .then(res => {
                var i, temparray;
